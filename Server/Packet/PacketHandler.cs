...
class PacketHandler
{
    public static void C_MoveHandler(PacketSession _refSession, IMessage _iPacket)
    {
        ...
        JobTimer.m_Instance.Push(() =>
        {
            ...
            PositionInfo refPosition = refPlayer.Position;
            ...
            refPlayer.Position.MoveDir = pkt.PosInfo.MoveDir;
            refPlayer.SetPosition(vPosition.X, vPosition.Y, vPosition.Z); //마지막 인자 Z
            sPkt.PosInfo = refPlayer.Position;
